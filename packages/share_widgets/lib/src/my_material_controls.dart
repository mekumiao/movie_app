...
class _MyMaterialControlsState extends State<MyMaterialControls> with SingleTickerProviderStateMixin {
  ...
  bool _isShowProgressRote = false;
  int _stepSize = 0;
  int _inSeconds = 0;
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        onHorizontalDragUpdate: (detail) {
          /// 设置增量
          _stepSize = (detail.localPosition.dx - _startPositionX) ~/ 3;
          setState(() {});
        },
        onHorizontalDragEnd: (detail) {
          controller.seekTo(Duration(seconds: _inSeconds + _stepSize));
          _isShowProgressRote = false;
          setState(() {});
        },
        onHorizontalDragStart: (details) {
          _startPositionX = details.localPosition.dx;
          _stepSize = 0;
          _inSeconds = controller.value.position.inSeconds;
          _isShowProgressRote = true;
          setState(() {});
        },
    ...
    return Visibility(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            Text(
              '${formatDuration(Duration(seconds: _inSeconds + _stepSize))} /',
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: CenterPlayButton(
          ...
          show: !_latestValue.isPlaying && !_dragging && !_hideStuff,
